 ...
 * page table lock.
 */
 /**__DONE__(nyz):�� pte_alloc ��������˵��
  * @brief �ڸ�����Ŀ¼�PMD���з���һ���µ�ҳ�����������ָ���������ַ��������
  * 
  *	@param struct mm_struct *mm ���ڴ�����ṹ��
  * @param pmd_t *pmd ��ָ��ҳĿ¼���ָ��
  * @param unsigned long address �������ַ������ȷ��ҳ�����λ��
  */
pte_t *pte_alloc(struct mm_struct *mm, pmd_t *pmd, unsigned long address)
{
	if (pmd_none(*pmd)) {						// ���ҳĿ¼���Ƿ�Ϊ��
		pte_t *new;

		/* "fast" allocation can happen without dropping the lock.. */
		new = pte_alloc_one_fast(mm, address);	// ���Կ��ٷ���һ���µ�ҳ���������ͷ���
		if (!new) {								// ������ٷ���ʧ�ܣ���û���㹻���ڴ棩�����ͷ������������ٷ���
			spin_unlock(&mm->page_table_lock);
			 ...
			 * entry, as somebody else could have populated it..
			 */
			if (!pmd_none(*pmd)) {				// ���ҳĿ¼���Ƿ���δ�գ���Ϊ��˵���ͷ����ڼ䣬�����߳�
												// �Ѿ�������ҳ���������Ҫ�ͷ��·����ҳ����
				pte_free(new);
				goto out;
			}
